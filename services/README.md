...
| `matching` | built — **Skill Fit only** (`skill-fit-v1`). No Job Match Score: work authorization is a hard constraint and is not evaluated (ADR-0037 + its Correction). Nothing calls `scorePostingForUser` |
