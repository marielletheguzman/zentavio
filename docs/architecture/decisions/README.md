...
| [0036](0036-when-skill-extraction-runs.md) | Extraction is its own pass over postings that record whether they were extracted, never a step inside the ingest transaction | Proposed | 2026-08-23 |
