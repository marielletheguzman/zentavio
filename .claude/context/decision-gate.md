...
|---|---|---|
| Origin-side authorities per domain | any verdict for a regulated profession | **research and one decision.** ADR-0029 (Proposed 2026-08-20) settles the modelling half ADR-0010 left open — how a rule names the origin it is about. Sourcing each authority stays research |
