...
| [0028](../../docs/architecture/decisions/0028-remote-as-a-destination.md) | `REMOTE` compares on employability alone, and its eligibility is `not_applicable` rather than unknown | Proposed |
