...
| [0025](../../docs/architecture/decisions/0025-derived-thresholds.md) | A threshold no authority publishes is computed by the connector and cites every instrument it came from | Proposed |
