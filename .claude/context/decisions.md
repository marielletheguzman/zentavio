...
| [0038](../../docs/architecture/decisions/0038-product-typeface.md) | Inter is the product typeface, self-hosted at build time through `next/font` and consumed by `--font-sans` | Accepted |
