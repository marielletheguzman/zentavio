...
| [0031](../../docs/architecture/decisions/0031-minimum-support-for-an-interview-process.md) | A company's interview process is described per role family, above a stated support floor, and never from a single report | Proposed |
